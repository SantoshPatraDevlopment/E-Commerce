...
import { getPrecisionNumber, getPriceAfterDiscount, getTotalPriceOfCart } from '../Utility/CommonLetterLowerToUpper'
...
function ShopingCart() {
    ...
    function decreseQuantity_click(productId) {
                        ...
                        <table className="table table-light table-borderless table-hover text-center mb-0">
                            ...
                            <tbody className="align-middle">
                                {arrCart.map(e => (<tr>
                                    ...
                                    <td className="align-middle del" ><del>${e.product.price}</del></td>
                                    <td className="align-middle">
                                        <div
                                        ...
                                        >
                                            <div className="input-group-btn">
                                                <button onClick={() => decreseQuantity_click(e.product.id)} className="btn btn-sm btn-primary btn-minus">
                        ...
                        <div className="bg-light p-30 mb-5">
                            ...
                            <div className="pt-2">
                                <div className="d-flex justify-content-between mt-2">
                                    <h5>Total</h5>
                                    <h5>${getPrecisionNumber((parseFloat(getTotalPriceOfCart(arrCart))+10),2)}</h5>
                                </div>
